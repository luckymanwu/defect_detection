...
def strip_optimizer(f='weights/best.pt'):  # from project.project import *; strip_optimizer()
...
def create_backbone(f='weights/best.pt'):  # from project.project import *; create_backbone()
...
def coco_only_people(path='../coco/labels/train2017/'):  # from project.project import *; coco_only_people()
...
def crop_images_random(path='../images/', scale=0.50):  # from project.project import *; crop_images_random()
...
def coco_single_class_labels(path='../coco/labels/train2014/', label_class=43):
    # Makes single-class coco datasets. from project.project import *; coco_single_class_labels()
...
def kmean_anchors(path='./data/coco64.txt', n=9, img_size=(640, 640), thr=0.20, gen=1000):
    # Creates kmeans anchors for use in *.cfg files: from project.project import *; _ = kmean_anchors()
    # n: number of anchors
    # img_size: (min, max) image size used for multi-scale training (can be same values)
    # thr: IoU threshold hyperparameter used for training (0.0 - 1.0)
    # gen: generations to evolve anchors using genetic algorithm
    from project.datasets import LoadImagesAndLabels
...
def plot_one_box(x, img, color=None, label=None, line_thickness=None):
    ...
    xm= int((int(x[0])+ int(x[2]))/ 2)  # x center
    ym= int((int(x[1]) + int(x[3]))/ 2 ) # y center
    # print("x=", xm, "y=", ym)
    # cv2.circle(img,(xm,ym),20,(0,255,0),-1,8,0)
...
def plot_wh_methods():  # from project.project import *; plot_wh_methods()
...
def plot_test_txt():  # from project.project import *; plot_test()
...
def plot_targets_txt():  # from project.project import *; plot_targets_txt()
...
def plot_evolution_results(hyp):  # from project.project import *; plot_evolution_results(hyp)
...
def plot_results_overlay(start=0, stop=0):  # from project.project import *; plot_results_overlay()
...
def plot_results(start=0, stop=0, bucket='', id=()):  # from project.project import *; plot_results()
