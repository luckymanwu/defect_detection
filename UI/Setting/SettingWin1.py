...
class SettingWin(QWidget):
    def setupUi(self, Setting):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 60, 391, 41))
        ...
        sizePolicy.setHeightForWidth(self.train_model_labe.sizePolicy().hasHeightForWidth())
        self.train_model_labe.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.train_model_labe.setFont(font)
        self.train_model_labe.setObjectName("train_model_labe")
        self.gridLayout_4.addWidget(self.train_model_labe, 2, 0, 1, 1)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.Skin_Setting.sizePolicy().hasHeightForWidth())
        self.Skin_Setting.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.bright_radioButton.setGeometry(QtCore.QRect(50, 70, 101, 20))
        self.bright_radioButton.setObjectName("bright_radioButton")
        self.dark_radioButton = QtWidgets.QRadioButton(self.Skin_Setting)
        self.dark_radioButton.setGeometry(QtCore.QRect(210, 70, 101, 20))
        ...
        self.xml_label = QtWidgets.QLabel(self.model_setting)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.xml_label.setFont(font)
        self.xml_label.setObjectName("xml_label")
        self.gridLayout_2.addWidget(self.xml_label, 3, 0, 1, 1)
        self.xml_lineEdit = QtWidgets.QLineEdit(self.model_setting)
        self.xml_lineEdit.setMinimumSize(QtCore.QSize(0, 35))
        self.xml_lineEdit.setObjectName("xml_lineEdit")
        self.gridLayout_2.addWidget(self.xml_lineEdit, 3, 1, 1, 1)
        self.xml_path_open = QtWidgets.QPushButton(self.model_setting)
        self.xml_path_open.setMinimumSize(QtCore.QSize(0, 35))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.xml_path_open.setFont(font)
        self.xml_path_open.setObjectName("xml_path_open")
        self.gridLayout_2.addWidget(self.xml_path_open, 3, 2, 1, 1)
    ...
    def retranslateUi(self, Setting):
        ...
        self.train_model_labe.setText(_translate("Setting", "train model:"))
        ...
        self.xml_label.setText(_translate("Setting", "xml save path:"))
        self.xml_path_open.setText(_translate("Setting", "open"))
