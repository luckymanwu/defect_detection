...
class SettingWin(QWidget):
    def setupUi(self, Setting):
        ...
        self.bright_value_label = QtWidgets.QLabel(self.Acquisition_Control)
        self.bright_value_label.setGeometry(QtCore.QRect(240, 60, 54, 12))
        self.bright_value_label.setText("")
        self.bright_value_label.setObjectName("bright_value_label")
        self.bright_label = QtWidgets.QLabel(self.Acquisition_Control)
        self.bright_label.setGeometry(QtCore.QRect(10, 61, 131, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.bright_label.setFont(font)
        self.bright_label.setObjectName("bright_label")
        self.bright_value_label = QtWidgets.QLabel(self.Acquisition_Control)
        self.bright_value_label.setGeometry(QtCore.QRect(140, 62, 51, 21))
        self.bright_value_label.setText("")
        self.bright_value_label.setObjectName("bright_value_label")

        self.contrast_value_label = QtWidgets.QLabel(self.Acquisition_Control)
        self.contrast_value_label.setGeometry(QtCore.QRect(240, 60, 54, 12))
        self.contrast_value_label.setText("")
        self.contrast_value_label.setObjectName("contrast_value_label")
        self.contrast_label = QtWidgets.QLabel(self.Acquisition_Control)
        self.contrast_label.setGeometry(QtCore.QRect(10, 90, 131, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.contrast_label.setFont(font)
        self.contrast_label.setObjectName("contrast_label")
        self.contrast_value_label = QtWidgets.QLabel(self.Acquisition_Control)
        self.contrast_value_label.setGeometry(QtCore.QRect(140, 90, 51, 21))
        self.contrast_value_label.setText("")
        self.contrast_value_label.setObjectName("contrast_value_label")

        self.fps_label = QtWidgets.QLabel(self.Acquisition_Control)
        self.fps_label.setGeometry(QtCore.QRect(12, 27, 250, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.fps_label.setFont(font)
        self.fps_label.setObjectName("fps_label")
        self.fps_value_label = QtWidgets.QLabel(self.Acquisition_Control)
        self.fps_value_label.setGeometry(QtCore.QRect(270, 29, 51, 21))
        ...
        # self.bright_label = QtWidgets.QLabel(self.layoutWidget)
        # font = QtGui.QFont()
        # font.setPointSize(12)
        # self.bright_label.setFont(font)
        # self.bright_label.setObjectName("bright_label")
        # self.horizontalLayout.addWidget(self.bright_label)
        # self.bright_value_label = QtWidgets.QLabel(self.layoutWidget)
        # self.fps_value_label.setText("")
        # self.fps_value_label.setObjectName("fps_value_label")
        # self.horizontalLayout.addWidget(self.fps_value_label)
        ...
        self.Detection_Setting = QtWidgets.QGroupBox(Setting)
        self.Detection_Setting.setFont(font)
        self.Detection_Setting.setObjectName("Detection_Setting")
        self.widget = QtWidgets.QWidget(self.Detection_Setting)
        self.widget.setGeometry(QtCore.QRect(23, 28, 311, 51))
        self.widget.setObjectName("widget")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.conf_label = QtWidgets.QLabel(self.widget)
        self.conf_label.setObjectName("conf_label")
        self.horizontalLayout_4.addWidget(self.conf_label)
        self.spinBox = QtWidgets.QSpinBox(self.widget)
        self.spinBox.setObjectName("spinBox")
        self.spinBox.setRange(60,100)
        self.spinBox.setValue(80)
        self.spinBox.setSingleStep(1)
        self.horizontalLayout_4.addWidget(self.spinBox)
        self.verticalLayout.addWidget(self.Detection_Setting)
    ...
    def retranslateUi(self, Setting):
        ...
        self.bright_label.setText(_translate("Setting", "Base Bright:"))
        self.contrast_label.setText(_translate("Setting", "Base Contrast:"))
