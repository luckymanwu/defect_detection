...
from UI.BatchPicDetectionMainWin import Ui_BatchpicDetectionMainWindow
from UI.QclickableImage import QClickableImage


class BatchPicDetectionWin(QtWidgets.QMainWindow,Ui_BatchpicDetectionMainWindow):
    def __init__(self):
        super(BatchPicDetectionWin, self).__init__()
        self.setupUi(self)
    ...
    def change_realtime_mode(self):
       TopBar.changeToDetectionMode(self)
    def change_pic_mode(self):
