...
class TrainWin(QWidget):
    def setupUi(self, Train):
        ...
        self.bright_label = QtWidgets.QLabel(self.sample)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.bright_label.setFont(font)
        self.bright_label.setObjectName("bright_label")
        self.horizontalLayout_3.addWidget(self.bright_label)
        self.sample_num_label = QtWidgets.QLabel(self.sample)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.sample_num_label.setFont(font)
        self.sample_num_label.setObjectName("sample_num_label")
        self.horizontalLayout_3.addWidget(self.sample_num_label)
    ...
    def retranslateUi(self, Train):
        ...
        self.bright_label.setText(_translate("Train", "图像亮度："))
        self.sample_num_label.setText(_translate("Train", "采样数："))
